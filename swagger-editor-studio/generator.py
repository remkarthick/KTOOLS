...
def default_openapi_spec():
    return {
                        ...
                        "get": {
                            ...
                            "responseSchemaRelations": {
                                ...
                                "400": {
                                    "type": "single",
                                    "items": [
                                        {"kind": "ref", "value": "#/components/schemas/ErrorResponse"}
                                    ]
                                }
                            },
                            "responseExampleRelations": {
                                ...
                                "400": {
                                    "type": "single",
                                    "items": [
                                        {"name": "validationError", "summary": "Validation error", "value": {"message": "Invalid page", "code": "INVALID_PAGE"}}
                                    ]
                                }
                            }
                        },
                        "post": {
                            ...
                            "responseExampleRelations": {
                                ...
                                "409": {
                                    "type": "single",
                                    "items": [
                                        {"name": "duplicateEmail", "summary": "Duplicate email", "value": {"message": "Email already exists", "code": "DUPLICATE_EMAIL"}}
                                    ]
                                }
                            }
                        }
        ...
        "info": {
            "title": "Swagger Studio v11",
            "description": "OpenAPI editor with explicit relationship model for endpoint schemas and examples.",
            "version": "1.0.0"
        },
...
<head>
    ...
    <title>Swagger Studio v11</title>
...
<body class="studio-body">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="#">Swagger Studio v11</a>
                ...
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center bg-info-subtle">
                        <div>
                            ...
                            <div class="small text-muted">Explicit OpenAPI relationship model for schemas and examples</div>
                        </div>
                    </div>
                    <div class="card-body panel-scroll">
...
function openOperationEditor(pathKey, method) {
    ...
    openModalEditor(`${method.toUpperCase()} ${pathKey}`, "Manage explicit endpoint-schema-example relationships.", `
        <div class="accordion">
            ...
            ${accordionItem("op-openapi-note", "OpenAPI Relationship Notes", `
                <ul class="mb-0">
                    <li><code>oneOf</code>, <code>anyOf</code>, and <code>allOf</code> are valid OpenAPI schema composition keywords.</li>
                    <li>Examples in OpenAPI are a named map, so relationship typing for examples is stored explicitly in <code>x-studio.relationships</code>.</li>
                    <li><code>single</code> is a studio convenience type that compiles to a single schema or examples map entry set.</li>
                    <li>Relationship metadata is preserved in <code>x-studio</code> while the generated OpenAPI remains valid 3.x.</li>
                </ul>
            `)}
        </div>
    `);
...
README = r'''# Swagger Studio v11

Features:
- explicit relationship model between endpoints, schemas, and examples
- supports endpoint ↔ request schema relationships
- supports endpoint ↔ response schema relationships
- supports endpoint ↔ request example relationships
- supports endpoint ↔ response example relationships
- relationship types:
  - single
  - oneOf
  - anyOf
  - allOf
- relationship metadata stored explicitly in x-studio
- generated OpenAPI remains valid 3.x
- request/response schema composition compiled into OpenAPI schema objects
- request/response examples compiled into OpenAPI examples maps
- Bootstrap 5 UI
- raw YAML/JSON panel
- live preview
...
OpenAPI natively supports schema composition via:
- oneOf
- anyOf
- allOf

Examples are represented as named example maps in OpenAPI, so explicit example relationship metadata is stored in:
- x-studio.relationships
